...
export const groupByOrderItemId = (data = [], resourcePlannedList = [], employeeId = null) => {
  const grouped = data.reduce((acc, item) => {
    const matchesEmployee = employeeId == null || String(item?.emp_id ?? item?.employee_id ?? "") === String(employeeId);
...
export const formatRetainerActivities1 = (apiData = [], resourcePlannedList = []) => {
  const grouped = buildActivityGroupMap(apiData);
...
export const getStatusVariant1 = (activityStatus) => {
