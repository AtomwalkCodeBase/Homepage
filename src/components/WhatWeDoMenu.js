...
const WhatWeDoMenu = ({ show, onClose, navbarHeight }) => {
    ...
    const products = [
        ...
        {
            id: 7,
            name: "Atomwalk NAAC Accreditation Management",
            icon: "🔬",
            link: "/naac.html",
            industries: [
                { name: "Dashboards & Readiness Tracking" },
                { name: "Curricular Aspects " },
                { name: "Teaching-Learning & Evaluation )" },
                { name: "Research, Innovation & Extension " },
                ...
                { name: "Department-wise Data Collection" },
                { name: "Scholarship & Financial Aid Tracking" }
            ],
            useCases: [
                { name: "IQAC & Principal's Readiness Dashboards", link: "/naac-view.html" },
                { name: "Curricular Aspects Management", link: "/curricular-aspects.html" },
                { name: "Teaching-Learning Process Management", link: "/teaching-learning.html" },
                { name: "Research, Innovation & Extension Management", link: "/research-extension.html" },
                { name: "Infrastructure & Learning Resources Management", link: "/infrastructure.htm" },
                { name: "Student Support & Progression Management", link: "/student-support.html" },
                { name: "Governance & Quality Initiatives Management", link: "/governance.html" },
                { name: "Institutional Values & Best Practices Management", link: "/values-best-practices.html" },
                { name: "Department-wise Coordinator Workflow", link: "/department.html" },
                { name: "Scholarship & Disbursement Workflow", link: "/scholarship.html" }
            ]
        },
        // {
        //     id: 7,
