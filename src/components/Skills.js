...
const IndustryContainer = styled(motion.div)`
  ...
  &:before {
    ...
    background: linear-gradient(
      to bottom,
      ${(props) => props.accentColor || "#6c5ce7"},
      transparent
    );
  }
...
const LearnMoreButton = styled(motion.button)`
  ...
  background: linear-gradient(
    45deg,
    ${(props) => props.accentColor || "#6c5ce7"},
    ${(props) => props.accentColor2 || "#a29bfe"}
  );
  color: #fff;
  border: none;
  border-radius: 30px;
...
export const Skills = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      description:
        "Atomwalk Facility Management System reshapes how residential communities and service providers coordinate and execute operational tasks. With smart scheduling, real-time task tracking, and smooth communication between all involved partners, our platform ensures efficient maintenance operations, improved accountability, and better service delivery.",
      image: Fms,
    ...
    {
      title: "IntelliAI Management",
      description:
        "Step into the future of industrial intelligence with Atomwalk’s AI-powered platform—designed to revolutionize safety, surveillance, quality control, and operational efficiency. From real-time PPE detection to anomaly alerts and defect monitoring, our system turns video feeds and sensor data into actionable insights—boosting compliance, product quality, and operational flow.",
      image:
