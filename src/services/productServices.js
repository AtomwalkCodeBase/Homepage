...
export function getBookingListView() {
  return authAxios(getBookingListURL)
}
...
export function getExpensePlannedItem(data) {
  // console.log(data)
  return authAxios(getExpensePlannedItemList, data)
}
export function postExpensePlannedItem(res) {
...
export function postContarctAllocationData(activity_data) {
  return authAxiosFilePost(processContractAllocation, activity_data);
}