...
export const ProcessFlow = ({ data, bgcolors }) => {
  const flows = {
    ...
    Viewboard: [
      { step: 'IQAC Dashboard', id: 'iqac-dashboard' },
      { step: 'Principal Dashboard', id: 'principal-dashboard' },
      { step: 'Department Dashboard', id: 'department-dashboard' },
      { step: 'IQAC Spider View', id: 'iqac-spider-view' },
    ],
    CurricularAspects: [
      { step: 'Programs', id: 'c1-programs' },
      { step: 'Curriculum Revisions', id: 'c1-curriculum-revisions' },
      { step: 'Stakeholder Feedback', id: 'c1-stakeholder-feedback' },
      { step: 'Add-on Courses', id: 'c1-addon-courses' },
      { step: 'Experiential Learning', id: 'c1-experiential-learning' },
      { step: 'Student Projects', id: 'c1-student-projects' },
    ],
    TeachingLearning: [
      { step: 'Student Enrolment and Profile', id: 'c2-enrolment-profile' },
      { step: 'Student-Teacher Ratio', id: 'c2-student-teacher-ratio' },
      { step: 'Teaching-Learning Process', id: 'c2-teaching-learning-process' },
      { step: 'Teacher Profile and Quality', id: 'c2-teacher-profile-quality' },
      { step: 'Evaluation Process and Reforms', id: 'c2-evaluation-process-reforms' },
      { step: 'Student Performance and Outcomes', id: 'c2-student-performance-outcomes' },
      { step: 'Student Satisfaction Survey', id: 'c2-student-satisfaction-survey' },
    ],
    ResearchExtension: [
      { step: 'Research Funding & Grants', id: 'c3-research-projects' },
      { step: 'IP & Patents', id: 'c3-patents' },
      { step: 'Publications & Indexing', id: 'c3-publications' },
      { step: 'Extension & Collaboration', id: 'c3-collaborative-activities' },
      { step: 'Reports & Dashboard', id: 'c3-phd-scholars' },
    ],
    Infrastructure: [
      { step: 'Assets & Laboratories', id: 'c4-frame-1' },
      { step: 'Library Resources & Summary', id: 'c4-frame-2' },
      { step: 'e-Library & ICT Facilities', id: 'c4-frame-3' },
      { step: 'Infra Expenditure & AMC Contracts', id: 'c4-frame-4' },
      { step: 'Qualitative Metrics', id: 'c4-frame-5' },
    ],
    StudentSupport: [
      { step: 'Scholarships & Placements', id: 'c5-frame-1' },
      { step: 'Achievements & Career Guidance', id: 'c5-frame-2' },
      { step: 'Capacity Building & Higher Education', id: 'c5-frame-3' },
      { step: 'Campus Life & Alumni', id: 'c5-frame-4' },
      { step: 'Grievance Redressal', id: 'c5-frame-5' },
    ],
    Governance: [
      { step: 'e-Governance & FDP', id: 'c6-frame-1' },
      { step: 'Faculty Financial Support & Funding Grants', id: 'c6-frame-2' },
      { step: 'Quality Initiatives', id: 'c6-frame-3' },
    ],
    ValuesBestPractices: [
      { step: 'Green Campus', id: 'c7-green-campus' },
      { step: 'Divyangjan Facilities', id: 'c7-divyangjan-facilities' },
      { step: 'Gender Sensitization', id: 'c7-gender-sensitization' },
      { step: 'Human Rights Activities', id: 'c7-human-rights-activities' },
      { step: 'Best Practices', id: 'c7-best-practices' },
      { step: 'Institutional Distinctiveness', id: 'c7-institutional-distinctiveness' },
    ],
    Department: [
      { step: 'Coordinator Assignment', id: 'dept-frame-1' },
      { step: 'Criterion Data Upload', id: 'dept-frame-2' },
      { step: 'Centralized Validation', id: 'dept-frame-3' },
      { step: 'SSR Preparation Handoff', id: 'dept-frame-4' },
    ],
    Scholarship: [
      { step: 'Scheme Registration', id: 'scholarship-frame-1' },
      { step: 'Beneficiary Mapping', id: 'scholarship-frame-2' },
      { step: 'Disbursement Tracking', id: 'scholarship-frame-3' },
      { step: 'Visibility & Reporting', id: 'scholarship-frame-4' },
    ],
  };
