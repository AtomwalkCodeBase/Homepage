...
const TermsOfService = () => {
    return (
        <Container>
            ...
            <Paragraph>
                This Agreement ("Agreement") is between <strong>You</strong> (<strong>the user, whether individual or entity</strong>) and <strong>Atomwalk Technologies Pvt. Ltd.</strong> (Hereinafter <strong>Atomwalk Technologies Pvt. Ltd.</strong>) a company having registered office at Gopalan Millennium Towers, ITPL Main Rd, Brookfield, Whitefield, Bengaluru, Karnataka 560037.
            </Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    In order to access and utilize the Services provided by Atomwalk Technologies Pvt. Ltd., you must first register for a user account by providing all required information, as prompted during the sign-up process. This account will grant you access to the full functionality of the Services, including any additional features or services that may be available upon subscription.
                </Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    By accessing and using the Services provided by Atomwalk Technologies Pvt. Ltd., you agree to adhere to several restrictions regarding your use of the platform. Your access to the Services is personal and non-transferable. You are prohibited from transferring or sublicensing your access to third parties, whether for free or for compensation. Additionally, you may not use the Services to provide any form of service to third parties, unless prior written permission is obtained from Atomwalk Technologies Pvt. Ltd. User licenses are assigned to individual users only, and sharing or reassigning your license to multiple users is prohibited, except in specific cases where reassignment is necessary.
                </Paragraph>
                <Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. may integrate with third-party applications ("Third Party Applications") as part of the Services we provide. By accessing or using any Third-Party Applications, you agree to review and comply with the applicable terms of service and privacy policies of those third parties. Atomwalk Technologies Pvt. Ltd. is not responsible for any issues related to the availability, performance, or functionality of Third-Party Applications. Any interactions or transactions with third-party providers are solely between you and the provider. We reserve the right, at our sole discretion, to suspend, remove, or limit access to any Third-Party Application without prior notice, and we are not liable for any loss, data, or service disruption that may result. You also agree to indemnify Atomwalk Technologies Pvt. Ltd. against any claims or damages arising from your use of such Third-Party Applications. Please note that Atomwalk Technologies Pvt. Ltd. is not responsible for the data practices of third-party providers, and you are encouraged to review their privacy policies to understand how your data is handled.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    At Atomwalk Technologies Pvt. Ltd., Services are offered through a range of subscription plans, each varying in duration. At the end of your subscription period, you will receive an alert notifying you of the upcoming renewal. If you wish to continue using the services, you may choose to renew your subscription. You have the option to update your payment method before the renewal date if needed. Periodically, Atomwalk Technologies Pvt. Ltd. may modify the pricing of its services or introduce charges for services that were once available without cost. Any adjustments to pricing will not affect your current subscription until the end of your billing cycle. Charges for the Services will only apply if you have selected a paid plan. Additionally, any applicable taxes such as GST/ VAT/ Sales tax, or other regional levies will be added to your subscription fees, and you agree to pay these additional amounts. Atomwalk Technologies Pvt. Ltd. will issue an invoice detailing these taxes to assist with any tax credits, as applicable.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    In the event that Atomwalk Technologies Pvt. Ltd. receives a complaint related to your activities while using the Services, we will forward the complaint to the primary email address associated with your user account. Upon receiving the forwarded complaint, you are required to respond directly to the complainant within ten (10) business days and include Atomwalk Technologies Pvt. Ltd. in the communication. Failure to provide a response within the stipulated timeframe will result in Atomwalk Technologies Pvt. Ltd. disclosing your name and contact details to the complainant, enabling them to pursue legal action if necessary. By not responding within the given time period, you explicitly consent to Atomwalk Technologies Pvt. Ltd. sharing your details with the complainant.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. is committed to addressing grievances in accordance with the relevant guidelines. If you have any grievances regarding our Services, please contact our e-mail info@atomwalk.com. We are dedicated to resolving any issues promptly and fairly, and will respond to your concerns in a timely manner.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. may provide sample files or applications designed to demonstrate the utility of our Services for various tasks. These samples consist of random, illustrative data and should not be relied upon for accuracy, completeness, or commercial use. Atomwalk Technologies Pvt. Ltd. does not offer any warranties, express or implied, regarding the functionality or suitability of these sample files or applications.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    You agree to indemnify and hold Atomwalk Technologies Pvt. Ltd. harmless from and against any and all claims, actions, proceedings, damages and liabilities arising out of the use of hardware and/ or software, any of your acts or omissions, or any action taken or liability incurred pursuant to any claim against Atomwalk Technologies Pvt. Ltd. This indemnification shall include payment of costs and lawyer's fees incurred by Atomwalk Technologies Pvt. Ltd. in the defense of any such action or claim.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. reserves the right to suspend, restrict, or temporarily disable your user account or access to certain features of the Services in the event of suspected unlawful activities, prolonged inactivity, or requests from legal authorities or governmental bodies. If your account is suspended or access is restricted, you will be notified via your registered email address. Should you wish to dispute this action, you must contact info@atomwalk.com within 30 days of receiving the notice. Failing to respond within this period may result in permanent termination of your account.
                </Paragraph>
                <Paragraph>
