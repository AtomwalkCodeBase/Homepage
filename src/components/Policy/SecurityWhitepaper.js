    ...
    return (
        <Container>
            <Header>
                ...
                <LastUpdated>Security at Atomwalk Technologies Pvt. Ltd.</LastUpdated>
            </Header>

            <Section>
                <SectionTitle>Security</SectionTitle>
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. is committed to safeguarding information assets, client data, intellectual property, and development environments. As a software development company, Atomwalk Technologies Pvt. Ltd. implements organizational, technical, and physical security measures designed to protect data throughout the software development lifecycle, from requirements and design to development, testing, deployment, and maintenance.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Security considerations are embedded into the software development lifecycle at Atomwalk Technologies Pvt. Ltd.. Secure design principles, code reviews, testing practices, and risk assessments are applied to reduce vulnerabilities and ensure that applications developed for clients align with security best practices.
                </Paragraph>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. maintains formal incident management procedures to ensure that security events are identified, reported, assessed, and handled in a consistent and timely manner. Employees are trained to recognize potential security incidents, including unauthorized access, data exposure, system compromise, or policy violations, and to report such events through defined internal channels. Once reported, incidents are documented, investigated to determine scope and impact, and addressed through corrective and preventive actions. This structured approach enables Atomwalk Technologies Pvt. Ltd. to minimize harm, restore normal operations, and continuously improve its security controls based on lessons learned.
                </Paragraph>

                <SubsectionTitle>Breach notification</SubsectionTitle>
                <Paragraph>
                    In the event of a confirmed security breach involving client data, Atomwalk Technologies Pvt. Ltd. follows a defined notification process in accordance with contractual commitments and applicable legal or regulatory requirements. Notifications are provided in a timely manner and include relevant information to help clients understand the nature of the incident, its potential impact, and the steps taken to mitigate risk. Atomwalk Technologies Pvt. Ltd. works cooperatively with affected clients during incident response and remediation efforts to support transparency and trust.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. encourages the responsible disclosure of security vulnerabilities by clients, partners, and independent security researchers. Vulnerability reports are reviewed by qualified personnel, validated, and prioritized based on potential risk and impact. Appropriate remediation actions are implemented in a timely manner, and disclosures are handled in a coordinated and professional way to reduce the likelihood of exploitation. This approach supports continuous improvement of security controls and demonstrates Atomwalk Technologies Pvt. Ltd.' commitment to maintaining secure development practices.
                </Paragraph>
            </Section>
            ...
            <Section>
                ...
                <Paragraph>
                    Atomwalk Technologies Pvt. Ltd. works collaboratively with clients to align security practices with client-specific requirements and contractual obligations. Clients may define access controls, approval processes, data handling expectations, communication protocols, and project-specific security measures as part of project governance. Atomwalk Technologies Pvt. Ltd. supports these controls through role-based access, segregation of project environments, and transparent communication, enabling clients to maintain oversight and confidence in how their data and intellectual property are protected throughout the engagement.
                </Paragraph>
            </Section>
            ...
            <NoteBox>
                ...
                <Paragraph style={{ marginTop: '0.5rem', marginBottom: 0 }}>
                    Atomwalk Technologies Pvt. Ltd. is dedicated to continuously improving its security posture through regular assessments, employee training, and adherence to industry best practices. For any security-related inquiries or responsible disclosure of vulnerabilities, please contact our security team.
                </Paragraph>
            </NoteBox>

            <Footer>
                <p>Atomwalk Technologies Pvt. Ltd. Pvt. Ltd. — Gopalan Millennium Towers, ITPL Main Rd, Brookfield, Whitefield, Bengaluru, Karnataka 560037</p>
            </Footer>
        </Container>
    );
};
