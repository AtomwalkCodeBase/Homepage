  ...
  const features = isClaim
    ? [
      ...
      },
      {
        ...
        description: "Employees can submit expense claims by selecting multiple expense items under a single claim, adding project details if needed, and uploading supporting documents like bills and receipts. This helps them organize and track their claims more efficiently. The mobile app allows instant receipt capture and submission, speeding up the entire process for both employees and the company—enabling real-time approval and settlement.",
        benefits: [
          "Multiple Claim Items in One Submission",
      ...
      },
      {
        ...
        description: "Submitted claims are automatically routed to managers for review, with smart workflows that verify approval authority based on grade level and amount limits. Managers can take action at the item level—approving, rejecting, forwarding to a higher-level manager, or sending back specific items to the claimant for clarification. This granular control ensures transparency and accountability. The mobile app enables real-time processing for fast and efficient claim settlements, with full digital records for easy tracking.",
        benefits: [
          "Item-Level Approval and Transparency",
          "Multiple Actions: Approve, Reject, Forward, Send Back",
